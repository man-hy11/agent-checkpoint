Execute the planned performance optimization work.

First read:

- repository agent instructions;
- this work package's `WORK.md` or specific work-description file;
- `CURRENT.md`;
...
Follow all Performance Optimization-specific hard rules from this template and the generated work package.
